        ...
        <div className='max-w-[1440px] md:mt-24 md:mb-24'>
          ...
          <div className="flex flex-col items-center text-center transition duration-500 ease-in-out text-white py-12 px-6 md:py-20 md:px-16 rounded-lg shadow-custom mb-10">
            ...
            <p className="text-base md:text-lg text-white mt-4">
              ...
              <br />
              And of course <a className='text-sky-500 hover:text-sky-600 transition-all duration-300 ease-in-out' target='_blank' href="https://tailwindcss.com">
                Tailwind CSS </a>
              for styling.
            </p>
          </div>
          ...
          <section className="text-center">
            <h2 className="text-2xl md:text-3xl font-semibold text-white mb-4 md:mb-6">Get Started with The App!</h2>
